...
.DESCRIPTION
    The Get-LinuxWSLDistributionInfo function retrieves information about the Linux distribution running under the Windows Subsystem for Linux (WSL). 
...
.EXAMPLE
    Get-LinuxWSLDistributionInfo -Set 'Full' -Format 'PSObject'
...
.EXAMPLE
    Get-LinuxWSLDistributionInfo -Set 'VersionString' -Format 'String'
...
#>
function Get-LinuxWSLDistributionInfo {
    param (
